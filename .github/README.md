...
Silver is a simple bot that is currently being developed and expanded on. It utilizes Discord's slash commands feature, opposed to more traditional commands. Its features are specifically built to fit the means of the Pokémon Mystery Dungeon: Silver Saviors of the Sky Discord server.
...
## Usage
If you would like to see Raichu in action, click [here](https://discord.nightkingale.com) to join the server that Silver, named Raichu over there, came from. Silver in this form is on [our Discord server!](https://discord.gg/aEYSz2yXpm)
...
* [Lazr1026](https://github.com/Lazr1026), for maintaining and testing Raichu's code alongside Nightkingale.
